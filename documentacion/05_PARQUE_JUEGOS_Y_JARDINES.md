...
- Está inmediatamente al este del monasterio y al norte del parque de estancia.
- Es abierto y parcialmente cubierto mediante velarias o pérgolas permanentes.
- Incluye columpios, estructura de trepa y tobogán, equilibrio, área infantil tranquila, pavimento amortiguador, bancos y fuente.
...
- No existe un tercer camino largo central.
- Contiene exactamente 14 bancos: siete asociados a cada camino largo.
- En cada camino, posiciones 1, 3, 5 y 7 al exterior; posiciones 2, 4 y 6 al interior, junto al césped central.
- Cada banco mira hacia su camino más próximo y se apoya en una pequeña plataforma lateral.
- Bancos de madera y estructura de forja negra coordinada con la cancela.
- Las farolas del parque tienen un solo poste y exactamente un farol.

## Correspondencia de vistas del parque

- Planta: ortogonal a 90°, norte arriba, sin fachadas visibles.
...
- [ ] Dos caminos largos y un único conector corto.
- [ ] Exactamente 14 bancos, todos orientados hacia su camino.
